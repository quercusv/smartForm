...
<html>
    ...
    <body>
        ...
        <p>
            MIT license.  Download <a href="https://github.com/quercusv/smartForm/archive/master.zip">here</a>, the files you need are in the dist/ folder.  Or, <pre>bower install smartForm --save</pre>
        </p>
